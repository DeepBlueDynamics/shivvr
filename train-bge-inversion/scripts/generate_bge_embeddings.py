#!/usr/bin/env python3
"""Generate BGE-small embeddings for MSMARCO dataset."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate BGE embeddings for MSMARCO")
    parser.add_argument("--model_name", type=str, default="BAAI/bge-small-en-v1.5")
    parser.add_argument("--output_dir", type=str, default="./embeddings/bge-small-msmarco")
