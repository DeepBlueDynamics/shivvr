...
def main(args):
    ...
    for sentence in test_sentences:
        ...
        for step in range(args.num_corrections):
            ...
            with torch.no_grad():
                new_outputs = bge_model(**new_inputs)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hypothesis_model", type=str, default="./saves/bge-small-hypothesis/best_model.pt")
    parser.add_argument("--corrector_model", type=str, default="./saves/bge-small-corrector/best_model.pt")
